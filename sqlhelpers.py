...
def get_blockchain():
    ...
    for b in blockchain_sql.getall():
        blockchain.add(Block(int(b.get('number')),b.get('data'),b.get('previous'),int(b.get('nonce'))))
...
def sync_blockchain(blockchain):
    ...
    for block in blockchain.chain:
        blockchain_sql.insert(str(block.Number), block.hash(), block.prev_hash, block.data, block.nonce)

def test_blockchain_sql():
    blockchain_sql = Table("blockchain", "number", "hash", "previous", "data", "nonce")
    blockchain_sql.deleteall()
